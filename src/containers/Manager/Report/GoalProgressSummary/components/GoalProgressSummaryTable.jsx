...
import GoalProgressSummaryFilter from "./GoalProgressSummaryFilter";
...
const DataTable = ({organization, program, programs}) => {
  ...
  const apiUrl = `/organization/${organization.id}/report/goal-progress-summary`;
