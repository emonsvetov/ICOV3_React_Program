...
import GoalProgressSummaryTable from './GoalProgressSummaryTable';
import axios from "axios";
import {isEmpty} from '@/shared/helpers'
import {connect} from "react-redux";

const GoalProgressSummaryIndex = ({ organization, program }) => {
  ...
  return (
    <Col md={12}>
      <Card>
        <CardBody>
          <GoalProgressSummaryTable programs={defaultPrograms} />
        </CardBody>
      </Card>
    </Col>
  )
...
export default connect(mapStateToProps)(GoalProgressSummaryIndex);