...
import MerchantRedemptionFilter from "./MerchantRedemptionFilter";
...
const DataTable = ({organization, program, programs}) => {
  ...
  const apiUrl = `/organization/${organization.id}/report/merchant-redemption`;
