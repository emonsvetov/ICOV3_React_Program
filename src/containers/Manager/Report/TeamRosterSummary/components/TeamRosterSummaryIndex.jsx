...
import TeamRosterSummaryTable from './TeamRosterSummaryTable';
import axios from "axios";
import {isEmpty} from '@/shared/helpers'
import {connect} from "react-redux";

const TeamRosterSummaryIndex = ({ organization, program }) => {
  ...
  return (
    <Col md={12}>
      <Card>
        <CardBody>
          <TeamRosterSummaryTable programs={defaultPrograms} />
        </CardBody>
      </Card>
    </Col>
  )
...
export default connect(mapStateToProps)(TeamRosterSummaryIndex);