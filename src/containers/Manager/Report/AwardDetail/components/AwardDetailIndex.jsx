...
import AwardDetailTable from './AwardDetailTable';
import axios from "axios";
import {isEmpty} from '@/shared/helpers'
import {connect} from "react-redux";

const AwardDetailIndex = ({ organization, program }) => {
  ...
  return (
    <Col md={12}>
      <Card>
        <CardBody>
          <AwardDetailTable programs={defaultPrograms} />
        </CardBody>
      </Card>
    </Col>
  )
...
export default connect(mapStateToProps)(AwardDetailIndex);