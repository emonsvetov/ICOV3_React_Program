...
import AnnualAwardSummaryTable from './AnnualAwardSummaryTable';
import axios from "axios";
import {isEmpty} from '@/shared/helpers'
import {connect} from "react-redux";

const AwardSummaryIndex = ({ organization, program }) => {
  ...
  return (
    <Col md={12}>
      <Card>
        <CardBody>
          <AnnualAwardSummaryTable programs={defaultPrograms} />
        </CardBody>
      </Card>
    </Col>
  )
...
export default connect(mapStateToProps)(AwardSummaryIndex);