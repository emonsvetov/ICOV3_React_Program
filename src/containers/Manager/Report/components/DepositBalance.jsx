...
import { DEPOSIT_BALANCE_COLUMNS, DEPOSIT_BALANCE_DATA  } from './Mockdata';
...
const DepositBalance = () => {
    ...
    const data = React.useMemo(() => DEPOSIT_BALANCE_DATA, [])
    ...
    */
    ...
    useEffect(() => {
        // return setUsers[DEPOSIT_BALANCE_DATA];
    }, [])
