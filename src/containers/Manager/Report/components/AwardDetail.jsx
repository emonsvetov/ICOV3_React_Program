...
import { AWARD_DETAIL_COLUMNS, AWARD_DETAIL_DATA } from "./Mockdata";
...
const AwardDetail = () => {
  ...
  let final_columns = [...AWARD_DETAIL_COLUMNS];

  const columns = React.useMemo(() => final_columns, []);
  const data = React.useMemo(() => AWARD_DETAIL_DATA, []);
  ...
  useEffect(() => {
    // return setUsers[AWARD_DETAIL_DATA];
  }, []);
