...
import { PARTICIPANT_ACCOUNT_COLUMNS, PARTICIPANT_ACCOUNT_DATA  } from './Mockdata';
...
const ParticipantAccount = () => {
    ...
    const data = React.useMemo(() => PARTICIPANT_ACCOUNT_DATA, [])
    ...
    */
    ...
    useEffect(() => {
        // return setUsers[PARTICIPANT_ACCOUNT_DATA];
    }, [])
