...
import { AWARD_SUMMARY_COLUMNS, AWARD_SUMMARY_DATA } from "./Mockdata";
...
const AwardSummary = () => {
  ...
  let final_columns = [...AWARD_SUMMARY_COLUMNS];

  const columns = React.useMemo(() => final_columns, []);
  const data = React.useMemo(() => AWARD_SUMMARY_DATA, []);
  ...
  useEffect(() => {
    // return setUsers[AWARD_SUMMARY_DATA];
  }, []);
