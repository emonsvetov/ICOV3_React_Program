...
import { PROGRAM_STATUS_COLUMNS, PROGRAM_STATUS_DATA } from "./Mockdata";
...
const ProgramStatus = () => {
  ...
  const data = React.useMemo(() => PROGRAM_STATUS_DATA, []);
  ...
  useEffect(() => {
    // return setUsers[PROGRAM_STATUS_DATA];
  }, []);
