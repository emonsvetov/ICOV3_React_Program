...
import { MERCHANT_REDEMPTION_COLUMNS, MERCHANT_REDEMPTION_DATA  } from './Mockdata';
...
const MerchantRedemption = () => {
    ...
    const data = React.useMemo(() => MERCHANT_REDEMPTION_DATA, [])
    ...
    */
    ...
    useEffect(() => {
        // return setUsers[MERCHANT_REDEMPTION_DATA];
    }, [])
...
export default MerchantRedemption