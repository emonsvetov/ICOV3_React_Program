...
import AwardAccountSummaryGLTable from './AwardAccountSummaryGLTable';
import axios from "axios";
import {isEmpty} from '@/shared/helpers'
import {connect} from "react-redux";

const AwardAccountSummaryGLIndex = ({ organization, program }) => {
  ...
  return (
    <Col md={12}>
      <Card>
        <CardBody>
          <AwardAccountSummaryGLTable programs={defaultPrograms} />
        </CardBody>
      </Card>
    </Col>
  )
...
export default connect(mapStateToProps)(AwardAccountSummaryGLIndex);